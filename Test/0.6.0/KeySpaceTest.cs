...
namespace HectorSharp.Test._060
{
	public class KeySpaceTest : IUseFixture<TestFixture>
	{
		...
		public void Failover()
		{
			...
			var h1cassandra = new Mock<Apache.Cassandra060.Cassandra.Client>(tprotocol.Object);
			var h2cassandra = new Mock<Apache.Cassandra060.Cassandra.Client>(tprotocol.Object);
			var h3cassandra = new Mock<Apache.Cassandra060.Cassandra.Client>(tprotocol.Object);
			...
			keyspace1desc.Add(HectorSharp.Service._060.Keyspace.CF_TYPE, HectorSharp.Service._060.Keyspace.CF_TYPE_STANDARD);
			...
			var ks = new Service._060.Keyspace(h1client.Object, keyspaceName, description, consistencyLevel, failoverPolicy, clientPool.Object, monitor.Object);
			...
			h1cassandra.Setup(c =>
				c.insert(
					It.IsAny<string>(),
					It.IsAny<string>(),
					It.IsAny<Apache.Cassandra060.ColumnPath>(),
					It.IsAny<byte[]>(),
					It.IsAny<long>(),
					It.IsAny<Apache.Cassandra060.ConsistencyLevel>())
			...
			ks = new Service._060.Keyspace(h1client.Object, keyspaceName, description, consistencyLevel, failoverPolicy, clientPool.Object, monitor.Object);
