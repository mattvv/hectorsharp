...
namespace HectorSharp.Service
{
    ...
    public interface Keyspace
    {
         ...
         */
        Dictionary<String, SuperColumn> multigetSuperColumn(List<String> keys, ColumnPath columnPath,
            boolean reversed, int size);

        /**
         * Performs a get_slice for columnParent and predicate for the given keys in
         * parallel.
         */
        Dictionary<String, List<Column>> multigetSlice(List<String> keys, ColumnParent columnParent,
            SlicePredicate predicate);
         ...
         */
        Dictionary<String, List<SuperColumn>> multigetSuperSlice(List<String> keys,
         ...
         */
        Dictionary<String, Map<String, String>> describeKeyspace();
