...
namespace HectorSharp.Service
{
	 ...
	 *
	 */
	public interface ICassandraClientPool
	{
		 ...
		 * @return
		 */
		ICassandraClient borrowClient(String url, int port);
		 ...
		 */
		ICassandraClient borrowClient(String urlPort);
		...
		List<String> getExhaustedPoolNames();
		 ...
		 */
		void invalidateClient(ICassandraClient client);
	}
}
